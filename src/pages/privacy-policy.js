...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <p>
      ...
      a website form, or other direct contact from you. We will not sell or rent
    ...
    <p>
      ...
      request, e.g. to process a payment.
    </p>
    <p>
    ...
    <p>
      ...
      information is encrypted and transmitted to a trusted third party in a
    ...
    <p>
      ...
      the information to perform a specific job (for example, license processing
    ...
    <p>
      ...
      about the products/services on our site in which you have expressed
      interest. At your option, you may also provide demographic information
    ...
    <p>
      ...
      information on our site. Some of our business partners may use cookies on
      our site. However, we have no access to or control over these cookies.
    </p>
    <h2>Sharing</h2>
    ...
    <p>
      ...
      <a href="mailto:support@intelsnap.com"> support@intelsnap.com</a>).
    </p>
  </Layout>
)
