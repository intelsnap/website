...
const Home = () => (
  <Layout>
    <div
      className="cont"
      style={{ textAlign: 'justify', padding: '0px 10px', margin: '0px 270px' }}
    >
      <h1
        style={{
          color: 'black',
      ...
      <p>
        ...
        <Link to="https://intepsnap.com"> https://intepsnap.com </Link>This
      ...
      <p>
        ...
        email, a website form, or other direct contact from you. We will not
      ...
      <p>
        ...
        identifiable information on our site. Some of our business partners may
      ...
      <p>
        ...
        <Link to="support@intelsnap.com"> support@intelsnap.com</Link>).
      </p>
    </div>
  </Layout>
)
