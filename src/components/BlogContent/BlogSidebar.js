      ...
      <div className="widget widget_tracer_posts_thumb">
        ...
        <article className="item">
          ...
          <div className="info">
            ...
            <h4 className="title usmall">
              <Link to="#">The Data Surrounding Higher Education</Link>
            </h4>
          </div>
        ...
        <article className="item">
          ...
          <div className="info">
            ...
            <h4 className="title usmall">
              <Link to="#">Conversion Rate the Sales Funnel Optimization</Link>
            </h4>
          </div>
        ...
        <article className="item">
          ...
          <div className="info">
            ...
            <h4 className="title usmall">
              <Link to="#">Business Data is changing the world’s Energy</Link>
            </h4>
          </div>
